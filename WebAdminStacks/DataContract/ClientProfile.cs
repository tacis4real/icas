...
{
    [Table("ICASWebAdmin.ClientProfile")]
    public class ClientProfile
    {

        public ClientProfile()
        {
            ClientDevices = new HashSet<ClientDevice>();
            ClientLoginActivities = new HashSet<ClientLoginActivity>();
        ...
        public virtual ICollection<ClientLoginActivity> ClientLoginActivities { get; set; }
